...
export const metadata = {
  title: "About | Kaya Bookkeeping",
  description: "Learn more about Kaya Bookkeeping, the client experience, and the value behind the service.",
};
        ...
        <div className="mt-12 grid gap-12 lg:grid-cols-[1.4fr_1fr]">
          <div className="space-y-8 rounded-[2rem] border border-emerald-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-base leading-8 text-slate-600">
              Kaya Bookkeeping LLC is positioned as the business partner that helps owners get
              organized, stay current, and make better day-to-day financial decisions.
            </p>
            <p className="text-base leading-8 text-slate-600">
